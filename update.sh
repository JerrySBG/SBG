...
res1() {
    wget https://raw.githubusercontent.com/JerrySBG/scvps/main/limit/menu.zip
    unzip menu.zip
    chmod +x menu/*
...
function noobzvpn() {
wget "https://raw.githubusercontent.com/JerrySBG/scvps/main/limit/noobzvpns.zip"
unzip noobzvpns.zip
bash install.sh
rm noobzvpns.zip
systemctl restart noobzvpns
print_success "ByJERRY®"
}
